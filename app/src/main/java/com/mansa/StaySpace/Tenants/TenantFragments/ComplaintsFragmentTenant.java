...
public class ComplaintsFragmentTenant extends Fragment {
    View v;
    ...
    public ComplaintsFragmentTenant() {
    }
    ...
    void refresh()
    {
        getContext().startService(new Intent(getContext(),GetTenantPeersService.class));
    }
    ...
    static void setView()
    {
        if(GetTenantPeersService.chatContacts!=null) {
            chatContactList.clear();
            chatContactList.addAll(GetTenantPeersService.chatContacts);
