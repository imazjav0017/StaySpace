...
public class SendTokenTenantService extends IntentService {

    public SendTokenTenantService() {
        super("SendTokenTenantService");
    }
    @Override
     ...
     class SendTask extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                Log.i("SENDTENANTTOKENDATA", params[1]);
                int resp = connection.getResponseCode();
                Log.i("SENDTENANTTOKENRESP",String.valueOf(resp));
                if(resp==200)
                {
        ...
        protected void onPostExecute(String s) {
            if (s != null) {
                Log.i("SENDTENANTTOKENRESP",s);
            }
            else
            {
                Log.i("SENDTENANTTOKENRESP","ERRR");
