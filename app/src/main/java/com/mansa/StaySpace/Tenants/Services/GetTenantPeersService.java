...
public class GetTenantPeersService extends IntentService {
    public static List<ChatContact>chatContacts;
    public GetTenantPeersService() {
    ...
    void startTask() throws JSONException {
        ...
        {
            Log.i("GetTenantPeersService","Auth is Null");
        }
    }
    void setPeers(String s) throws JSONException {
        if(s!=null)
        {
            ...
            ComplaintsFragmentTenant.updateNow();
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
               Log.i("GetPeersResponse",s);
                ...
                Toast.makeText(GetTenantPeersService.this, "Please Check Your Internet Connection", Toast.LENGTH_SHORT).show();
            }
        }
    }
