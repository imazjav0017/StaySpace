...
import com.rent.rentmanagement.renttest.Adapters.BuildingListSwitchingAdapter;
...
public class SwitchBuildingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.owner_activity_switch_building);
        Toolbar toolbar=(Toolbar)findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("My Buildings");
        buildingsList = (RecyclerView) findViewById(R.id.buildingNamesSwitchingRv);
        buildingListModels = new ArrayList<>();
        adapter = new BuildingListSwitchingAdapter(buildingListModels);
