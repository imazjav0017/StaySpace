...
import com.rent.rentmanagement.renttest.Owner.studentProfile;
...
StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ...
    public StudentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.owner_room_detail_tenant_item,parent,false);
